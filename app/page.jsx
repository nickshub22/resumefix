...
const CoverLetterPanel = ({ resumeData, jobDesc }) => {
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "80px 2rem 4rem" }}>
          ...
          {tab === "upload" && (
            <div>
              ...
              <p style={{ color: COLORS.muted, marginBottom: "2rem" }}>Upload your resume and our AI will parse and analyze it instantly.</p>
                ...
                <div>
                  <div className="card">
                    ...
                    {[
                      ...
                      ["4️⃣", "Fix with one click"],
                      ["5️⃣", "Match to job descriptions"],
                      ["6️⃣", "Generate cover letter & export"],
                    ].map(([num, text]) => (
                  ...
                  <div className="card" style={{ background: "linear-gradient(135deg, rgba(108,99,255,0.12), rgba(0,212,170,0.08))", borderColor: COLORS.accent }}>
                    ...
                    <div style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, marginBottom: "0.25rem" }}>ATS-Optimized Results</div>
                    <div style={{ color: COLORS.muted, fontSize: "0.85rem", lineHeight: 1.6 }}>Our AI simulates 50+ ATS systems including Workday, Greenhouse, Lever, and Taleo to ensure maximum compatibility.</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          {tab === "cover" && (
            <div>
              ...
              <div className="card">
                <CoverLetterPanel resumeData={resumeData || {}} jobDesc={jobDesc} />
              </div>
